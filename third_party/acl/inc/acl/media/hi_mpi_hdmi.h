...
typedef enum {
    ...
    HI_HDMI_CONTENT_GRAPHIC = HI_HDMI_CONTNET_GRAPHIC,
    HI_HDMI_CONTNET_PHOTO,
    HI_HDMI_CONTENT_PHOTO = HI_HDMI_CONTNET_PHOTO,
    HI_HDMI_CONTNET_CINEMA,
    HI_HDMI_CONTENT_CINEMA = HI_HDMI_CONTNET_CINEMA,
    HI_HDMI_CONTNET_GAME,
    HI_HDMI_CONTENT_GAME = HI_HDMI_CONTNET_GAME,
...
typedef enum {
    ...
    HI_HDMI_AUDIO_CODING_ONE_BIT_AUDIO = HI_HDMI_AUDIO_CODIND_ONE_BIT_AUDIO,
    HI_HDMI_AUDIO_CODING_ENAHNCED_AC3,
    HI_HDMI_AUDIO_CODING_ENHANCED_AC3 = HI_HDMI_AUDIO_CODING_ENAHNCED_AC3,
