...
#ifndef XLA_BACKENDS_NPU_COLLECTIVES_HCCL_COLLECTIVES_H_
#define XLA_BACKENDS_NPU_COLLECTIVES_HCCL_COLLECTIVES_H_
...
// XLA host-initiated collectives implemented on top of HCCL.
class HcclCollectives : public gpu::GpuCollectives {
 public:
  ...
  CreateCommunicatorsWithCancel(
      ...
      std::shared_ptr<xla::gpu::CancellationToken> cancel) final;
...
#endif  // XLA_BACKENDS_NPU_COLLECTIVES_HCCL_COLLECTIVES_H_
