...
==============================================================================*/
#ifndef XLA_PJRT_NPU_SE_ASCEND_TOPOLOGY_DESCRIPTION_H_
#define XLA_PJRT_NPU_SE_ASCEND_TOPOLOGY_DESCRIPTION_H_
...
class StreamExecutorAscendTopologyDescription : public PjRtTopologyDescription {
 public:
  StreamExecutorAscendTopologyDescription(
      const PjRtPlatformId platform_id, const absl::string_view platform_name,
      int number_of_devices, int num_devices_per_host,
      int number_of_hosts,
      const absl::flat_hash_map<std::string, PjRtDeviceAttribute>& attributes = {},
      std::optional<stream_executor::GpuTargetConfigProto> target_config = std::nullopt)
  ...
  bool operator==(const StreamExecutorAscendTopologyDescription& other) const {
  ...
  absl::StatusOr<int> ProcessCount() const override {
    return number_of_hosts_;
  }

  absl::StatusOr<int> ChipsPerProcess() const override {
    return num_devices_per_host_;
  }
  ...
  static absl::StatusOr<std::unique_ptr<StreamExecutorAscendTopologyDescription>>
...
#endif  // XLA_PJRT_NPU_SE_ASCEND_TOPOLOGY_DESCRIPTION_H_
